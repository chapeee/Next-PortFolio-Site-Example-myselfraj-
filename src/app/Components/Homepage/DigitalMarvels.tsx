  ...
  return (
    <div>
      ...
      <div className="z-[999] relative bg-gray-100">
        <div className="bg-siteDefaultColor text-white pt-14 pb-14 md:min-h-[500px] lg:min-h-[100vh] flex justify-center ">
          <div className="container m-auto p-5 pt-0 pb-0">
            <div
              className="text-[48px] sm:-[58px] lg:text-8xl font-medium text-center "
