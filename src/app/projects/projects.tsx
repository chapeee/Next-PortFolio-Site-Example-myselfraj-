  ...
  return (
    <div>
      ...
      <div className="relative z-[99] pt-[80px] md:pt-[150px] bg-white ">
        ...
        <div className="flex flex-wrap md:gap-6 gap-4 text-[18px] max-w-[950px] m-auto text-gray-600 font-medium"> <div className="border boder-1 border-gray-300 rounded-full pl-5 pr-5  p-2">Choreless</div>
        <div className="border boder-1 border-gray-300 rounded-full pl-5 pr-5 p-2  ">Jeff.co</div>
        <div className="border boder-1 border-gray-300 rounded-full pl-5 pr-5 p-2 ">Karat.io</div>
        <div className="border boder-1 border-gray-300 rounded-full pl-5 pr-5 p-2 ">Mithi.com</div>
        <div className="border boder-1 border-gray-300 rounded-full pl-5 pr-5 p-2 ">Fusioni Tech</div>
        <div className="border boder-1 border-gray-300 rounded-full pl-5 pr-5 p-2 ">Mithi</div>
        <div className="border boder-1 border-gray-300 rounded-full pl-5 pr-5 p-2 ">Marketing Crawlers</div>
        <div className="border boder-1 border-gray-300 rounded-full pl-5 pr-5  p-2 ">PRM Digital</div>
        <div className="border boder-1 border-gray-300 rounded-full pl-5 pr-5 p-2 ">2paws</div>
        <div className="border boder-1 border-gray-300 rounded-full pl-5 pr-5 p-2 ">LegacyFlow</div>
        <div className="border boder-1 border-gray-300 rounded-full pl-5 pr-5 p-2 ">Wibyng</div>
        <div className="border boder-1 border-gray-300 rounded-full pl-5 pr-5 p-2 ">Kapiva</div>
        <div className="border boder-1 border-gray-300 rounded-full pl-5 pr-5 p-2 ">Fm1</div>
        <div className="border boder-1 border-gray-300 rounded-full pl-5 pr-5  p-2">The Fold</div>
        <div className="border boder-1 border-gray-300 rounded-full pl-5 pr-5  p-2">Wapka</div>
        <div className="border boder-1 border-gray-300 rounded-full pl-5 pr-5 p-2 ">Educrafter Education</div>
        
        <div className="border boder-1 border-gray-300 rounded-full pl-5 pr-5 p-2 ">Rayforce Greentech</div>
        <div className="border boder-1 border-gray-300 rounded-full pl-5 pr-5 p-2 ">HaitinFlix</div>
        <div className="border boder-1 border-gray-300 rounded-full pl-5 pr-5 p-2 ">Motosports</div>
        <div className="border boder-1 border-gray-300 rounded-full pl-5 pr-5 p-2 ">JFlex</div>
        <div className="border boder-1 border-gray-300 rounded-full pl-5 pr-5 p-2 ">Petofy</div>
        <div className="border boder-1 border-gray-300 rounded-full pl-5 pr-5 p-2 ">Cynotech</div></div></div>
    </div>
    </div >
  );
}
